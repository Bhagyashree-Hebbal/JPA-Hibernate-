...
//@NamedQuery(name="getAll" ,query="select ce from CourseEntity ce ")
@NamedQuery(name = "findByPassword", query = "Select ce FROM CourseEntity ce WHERE ce.password = :password")
